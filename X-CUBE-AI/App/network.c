...
#define AI_TOOLS_DATE_TIME   "Mon Nov 14 10:10:09 2022"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 22472);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 22472);
    
    conv2d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 23552);
    conv2d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 23552);
    ...
    dense_1_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 22528);
    dense_1_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 22528);
    ...
    dense_2_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    dense_2_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    dense_3_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    dense_3_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 2048);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2048);
    
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 2624);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2560);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 363072);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 363072);
    
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 363648);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 363584);
    
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 371840);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 371840);
    
    dense_3_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 372352);
    dense_3_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 372352);
    
    dense_3_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 375424);
    dense_3_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 375424);
